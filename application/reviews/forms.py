...
class ReviewForm(FlaskForm):
    ...
    reviewText = StringField("Kirjoita arvostelu", [validators.length(min=4, max=144, message="Arvostelun pitää olla vähintään 4 merkkiä ja enintään 144 merkkiä pitkä!"), validators.DataRequired()])
    book_id = HiddenField()
